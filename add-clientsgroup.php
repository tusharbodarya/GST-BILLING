...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($loguser)){
	...
	if(isset($groupname) && isset($description)){
		$existsql = "SELECT * FROM tblclient_group WHERE name='$groupname' AND is_user='".$loguser."'";
		...
		if($existnumrows > 0){
			...
			$sql = "INSERT INTO `tblclient_group` ( `name`, `description`,`is_user`) VALUES ('".$groupname."', '".$description."', '".$loguser."')";
