				...
				<div class="card-body- pt-3 pb-4">
					<div class="table-responsive">
						<table id="datatable2" class="table table-striped dt-responsive nowrap table-hover" cellspacing="0">
							...
							<tbody>
								<?php
								$sql = "SELECT * FROM tbl_transaction  WHERE is_deleted='0' AND income_category='EXPENSE' AND is_user='".$loguser."'";
								...
								while($row = mysqli_fetch_assoc($result)){
									...
									<tr>
										...
										<?php
										$sql1 = "SELECT * FROM tbl_accounts  WHERE id='".$toaccount."' AND is_user='".$loguser."'";
										$result1 = mysqli_query($conn,$sql1) or die("SQL Query Failed 1.");
										...
										$sql2 = "SELECT * FROM $tbl  WHERE id='".$company_id."' AND is_user='".$loguser."'";
										$result2 = mysqli_query($conn,$sql2) or die("SQL Query Failed 2.");
