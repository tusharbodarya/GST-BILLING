				...
				<div class="card-body- pt-3 pb-4">
					<div class="table-responsive">
						<table id="datatable2" class="table table-striped dt-responsive nowrap table-hover" cellspacing="0">
							...
							<tbody>
								<?php
								$sql = "SELECT * FROM tbl_accounts  WHERE is_deleted='0' AND is_user='0' OR is_user='".$loguser."'";
								...
								while($row = mysqli_fetch_assoc($result)){
									...
									<tr>
										...
										<td><?php echo $name; ?></td>
										<?php
										$sql1 = "SELECT * FROM tbl_accountsgroup  WHERE id='".$accountsgroup."' AND is_user='".$loguser."'";
