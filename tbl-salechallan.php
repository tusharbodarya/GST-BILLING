			...
			<div class="card card-shadow mb-4">
				<div class="card-header border-0">
					<div class="custom-title-wrap bar-info">
						<div class="custom-title">MANAGE INVOICES  <a type="button" class="btn btn-outline-info" href="add-salechallan.php"><i class="icon-note mr-2"></i>ADD NEW</a></div>
					</div>
				</div>
				<div class="card-body- pt-3 pb-4">
					<div class="table-responsive">
						<table id="datatable2" class="table table-striped dt-responsive nowrap table-hover" cellspacing="0">
							...
							<tbody>
								<?php
								$sql = "SELECT * FROM tbl_salechallan  WHERE is_deleted='0' AND is_user='".$loguser."'";
								...
								while($row = mysqli_fetch_assoc($result)){
									...
									<tr>
										...
										<td class="text-center">
											<a href="view-saleinvoice.php?scid=<?php echo $id; ?>" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> View</a>&nbsp;
											<!-- <a href="edit-purchaseorder.php?id=<?php echo $id; ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i> Edit</a>&nbsp; -->
											<a href="delete.php?tbl=tbl_salechallan&id=<?php echo $id; ?>"class="btn btn-danger btn-xs delete-object" title="Delete"><i class="fa fa-trash"></i></a>
										</td>
									</tr>
