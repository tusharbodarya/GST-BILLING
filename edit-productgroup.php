...
include 'header.php';
	...
	$groupid = $_REQUEST['id'];
		$existsql = "SELECT * FROM tbl_productgroup WHERE id='$groupid'";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	if(isset($groupname) && isset($description)){
			$query =mysqli_query($conn, "UPDATE tbl_productgroup SET name='".$groupname."',description='".$description."' WHERE id='".$groupid."'")or die("SQL Query Failed.");
			if($query){
				$showalert = true;
			...
			<div class="card card-shadow mb-4">
				<div class="card-header border-0">
					<div class="custom-title-wrap bar-success">
						<div class="custom-title">Edit Product Group</div>
					</div>
				</div>
				<div class="card-body">
